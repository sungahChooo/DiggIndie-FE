  ...
  return (
    <div className="flex flex-col flex-none w-[160px] bg-[#1F1D1D] rounded-b-[4px]">
      <div className={'relative flex flex-col'}>
        ...
        />
        <div className={'flex flex-col absolute z-5 mt-[152px] mx-2'}>
          <span className={'w-[138px] h-[22px] text-base font-semibold'}>{indieStory.title}</span>
          <span className={'w-[138px] h-5 text-[14px]'}>{indieStory.description}</span>
        </div>
      </div>
    </div>
  );
